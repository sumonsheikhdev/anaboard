...
This module takes care of generating emoji data bundled with AnaBoard.
...
A gradle task called 'makeEmoji' builds and runs this tool to generate android resource file which. Path to AnaBoard's res directory is automatically set so the file is ready to be bundled at build.
