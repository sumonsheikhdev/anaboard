...
public class LatinIME extends InputMethodService implements
    ...
    public void onCreate() {
        ...
        // RECEIVER_EXPORTED is necessary because apparently Android 15 (and others?) don't recognize if the sender and receiver are the same app, see https://github.com/Helium314/AnaBoard/pull/1756
...
public View onCreateInputView() {
    ...
    // Ensure KeyboardSwitcher is initialized
    if (mKeyboardSwitcher == null) {
        throw new IllegalStateException("KeyboardSwitcher is not initialized");
    }

    final Context displayContext = KtxKt.getDisplayContext(this);
    ...
    if (inputView == null) {
        throw new IllegalStateException("KeyboardSwitcher returned null input view");
    }
    ...
    public void onComputeInsets(final InputMethodService.Insets outInsets) {
        ...
        if (isImeSuppressedByHardwareKeyboard() && !visibleKeyboardView.isShown()) {
            ...
            // way from OpenBoard to AnaBoard (GH-702, GH-1455), but not setting anything seems to work
    ...
    @Override
    public String onGetCurrentText() {
        if (mInputLogic.mConnection.hasSelection()) {
            CharSequence selectedText = mInputLogic.mConnection.getSelectedText(0);
            if (selectedText != null) return selectedText.toString();
        }
        CharSequence textBefore = mInputLogic.mConnection.getTextBeforeCursor(1000, 0);
        return textBefore != null ? textBefore.toString() : "";
    }

    @Override
    public void onReplaceText(@NonNull String text) {
        ...
        CharSequence textBefore = ic.getTextBeforeCursor(100000, 0);
        CharSequence textAfter = ic.getTextAfterCursor(100000, 0);
