...
class DictionaryFacilitatorImpl : DictionaryFacilitator {
    ...
    //  added in 12cbd43bda7d0f0cd73925e9cf836de751c32ed0 / https://github.com/Helium314/AnaBoard/issues/135
    ...
    //  see https://github.com/Helium314/AnaBoard/issues/307
    ...
    override fun addToUserHistory(
        ...
        if (sv.mAddToPersonalDictionary // require the opt-in
            && sv.mAutoCorrectEnabled == sv.mAutoCorrectionEnabledPerUserSettings // don't add if user wants autocorrect but input field does not, see https://github.com/Helium314/AnaBoard/issues/427#issuecomment-1905438000
