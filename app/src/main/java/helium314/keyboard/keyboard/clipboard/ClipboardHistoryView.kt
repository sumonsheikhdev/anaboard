...
class ClipboardHistoryView @JvmOverloads constructor(
    ...
    override fun onSharedPreferenceChanged(prefs: SharedPreferences?, key: String?) {
        ...
        // The setting can only be changed from a settings screen, but adding it to this listener seems necessary: https://github.com/Helium314/AnaBoard/pull/1903#issuecomment-3478424606
